...
public class MeineItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meine_items);


        verleihsystem.setCurrentFilterMeineItems();
        ...
        if (verleihsystem.getFilterReturnItemId().length != 0)
        {
            ...
            myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent myIntent = new Intent(MeineItemsActivity.this, MeinItemVerwaltenActivity.class);
